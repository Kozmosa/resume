...
= #redact(alter: "roife")[placeholder]
  ...
  == Work Experience
    ...
    #cventry(
        ...
        tl_comments: redact(alter: "")[ (20 recipients worldwide)],
        tr: [2024.09 - 2025.06 (expected)],
    )[
        - *Contributing to rust-analyzer* (the official Rust IDE)
          - Ranked *21/970* in contributors; resolved *over 50 issues* and contributing to multiple modules (e.g. *semantic analysis*, etc.), improving robustness of the project. Also introduced several new features (e.g. *control flow navigation*, etc.);
